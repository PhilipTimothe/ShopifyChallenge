...
class MainPage extends Component {
    ...
    // Mount initial data for the initial loadstart to page.
    componentDidMount() {
    ...
    // Toggle functionality that toggles heart to become red/liked or not red/liked
    toggle = e => {
    ...
    // Function purpose for seperation of bulky card code.  Edgecase for heart toggle for if true/ if false.
    renderLike(event) {
    ...
    // Modal functionality that pushes modal when called.  Sepeeration of concerns from component return at render.
    renderModal = e => {
